...
$stmt3 = $pdo->prepare("SELECT * FROM good_view_table WHERE id_view = :id_view AND gu_id = :gu_id AND gu_pw = :gu_pw");
...
//「いいね」をしていない場合登録
if($chc != "done"){
$sql = "INSERT INTO good_view_table(id_view,gu_name,gu_id,gu_pw)VALUES(:id_view, :gu_name, :gu_id, :gu_pw)";
